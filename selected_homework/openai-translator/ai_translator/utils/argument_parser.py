...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--config_file', type=str, default='E:\python\openai-quickstart\selected_homework\openai-translator\config.yaml', help='Configuration file with model and API settings.')
